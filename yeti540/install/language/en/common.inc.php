...
$arrLang['alert_remove_files'] = "<br/>For security reasons, please remove the entire <b>/install/</b> folder from your website. If you don't so this, you'll be redirected back to the /install folder when you try to load the site. Please also set permissions on ../_config.inc.php back to CHMOD 644.";
...
$arrLang['perform_upgrade_installation'] = "<b>Upgrade</b> from v5.x";
$arrLang['perform_upgrade_installation_prior_5'] = "<b>Upgrade</b> from v4.x";
