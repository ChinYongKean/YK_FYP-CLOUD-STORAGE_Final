...
class FileFolder extends Model
{
   public function getFolderUrl() {
    ...
    /**
     * Get the full path for the file folder
     *
     * @return string
     */
    public function getPath(): string {
        $folderListing = FileFolderHelper::loadAllActiveForSelect($this->userId,  '/', [], 5000);
        $path = '';
        if(isset($folderListing[$this->id])) {
            $path = $folderListing[$this->id];
        }
